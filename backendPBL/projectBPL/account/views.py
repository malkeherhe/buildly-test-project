...
from .serializers import (LoginSerializer, ProfileSerializer,
                          RegisterAdminSerializer, RegisterLearnerSerializer)
...
class LogoutView(APIView):
    ...
    def post(self, request):
        try:
            ...
            return Response(
                {"error": _("حدث خطأ أثناء تسجيل الخروج"), "details": str(e)},
                status=status.HTTP_400_BAD_REQUEST,
            )
...
class ProfileView(generics.RetrieveUpdateAPIView):
    ...
    def update(self, request, *args, **kwargs):
        ...
        return Response(
            {"message": _("تم تحديث الملف الشخصي بنجاح"), "user": serializer.data}
        )
