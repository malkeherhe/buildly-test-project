...
from .views import (CheckEnrollmentView, ConfirmDeleteCourseView,
                    CourseDetailView, CreateCourseView, DeleteCourseView,
                    JoinCourseView, ListCoursesView, RetrieveCourseView,
                    UpdateCourseView, UserEnrolledCoursesView)
...
urlpatterns = [
    ...
    path(
        "<int:id>/confirm-delete/",
        ConfirmDeleteCourseView.as_view(),
        name="confirm-delete",
    ),
