...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.AutoField(
                        primary_key=True, serialize=False, verbose_name="معرف المشروع"
                    ),
                ),
                (
                    "title",
        ...
        migrations.AddIndex(
            model_name="project",
            index=models.Index(
                fields=["course", "is_active"], name="projects_pr_course__8252d3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="project",
        ...
        migrations.AddIndex(
            model_name="project",
            index=models.Index(
                fields=["language"], name="projects_pr_languag_2ccd8c_idx"
            ),
        ),
