...
from .views import ConfirmDeleteProjectView  # ⭐ إضافة الاستيراد
from .views import (CourseProjectsView, CreateProjectView, DeleteProjectView,
                    ListProjectsView, ProjectDetailView, StartProjectView,
                    UpdateProjectView)
...
urlpatterns = [
    ...
    path(
        ...
        ConfirmDeleteProjectView.as_view(),
        name="confirm-delete",
    ),  # ⭐ إضافة مسار التأكيد
    ...
    path(
        "course/<int:course_id>/", CourseProjectsView.as_view(), name="course-projects"
    ),
