    ...
    def create(self, request, *args, **kwargs):
        try:
            ...
            if any("يوجد بالفعل مشروع بهذا العنوان" in msg for msg in error_messages):
                user_message = _(
                    "يوجد مشروع بنفس العنوان في هذا المسار. الرجاء استخدام عنوان مختلف."
                )
            ...
            if (
                "unique_project_title_per_course" in error_message
            ...
            return Response(
                {"success": False, "message": user_message, "error": error_message},
...
class ListProjectsView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        if user.is_admin:
            ...
            return Project.objects.filter(
                course__is_public=True, course__is_active=True, is_active=True
    ...
    def list(self, request, *args, **kwargs):
        ...
        if not queryset.exists():
            return Response({"message": _("لا توجد مشاريع متاحة"), "projects": []})
        ...
        try:
            ...
            if hasattr(e, "detail"):
                if isinstance(e.detail, dict):
                    ...
                    error_messages.append(
                        {"field": "general", "message": str(e.detail)}
                    )
            else:
...
class DeleteProjectView(generics.DestroyAPIView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        try:
            ...
            return Response(
                {
                    ...
                    "deletion_details": {
                        ...
                        "course_remaining_projects": Project.objects.filter(
                            course_id=project_info["course_id"], is_active=True
                        ).count(),
            ...
            return Response(
                {"success": False, "message": _("❌ فشل حذف المشروع"), "error": str(e)},
                status=status.HTTP_404_NOT_FOUND,
            )
...
class ConfirmDeleteProjectView(generics.RetrieveAPIView):
    ...
    def retrieve(self, request, *args, **kwargs):
        ...
        try:
            ...
            response_data = {
                ...
                "confirmation_details": {
                    ...
                    "action_buttons": [
                        ...
                        {"label": _("إلغاء"), "action": "cancel", "style": "secondary"},
                    ],
                },
            }
            ...
            return Response(
                {"success": False, "message": _("المشروع غير موجود"), "error": str(e)},
                status=status.HTTP_404_NOT_FOUND,
            )
    ...
    def post(self, request, pk):
        ...
        try:
            ...
            try:
                ...
                return Response(
                    {"success": False, "message": _("المشروع غير موجود")},
                    status=status.HTTP_404_NOT_FOUND,
                )
